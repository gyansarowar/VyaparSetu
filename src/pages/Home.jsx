...
//     <>
//       {/* Main Layout */}
//       <div className="mx-auto pt-4 grid min-h-[calc(100vh-50px)] grid-rows-3 grid-cols-12  ">
//         <Toaster
//           position="top-center"
//           reverseOrder={false}
...
//         <div className="col-span-3 row-span-2 bg-blue-700  flex flex-col  justify-end">
//           <div className=" sm:text-[20px] md:text-[35px] lg:text-[50px] text-yellow-400  font-bold h-1/3 flex flex-col items-center justify-center">
//             <div>For</div> 
//             <div>Exporters</div> 
//           </div>
//           <div className=" pt-4">
//             <img
//               src="src\assets\andy-li-CpsTAUPoScw-unsplash.jpg"
//               className="object-contain w-fit h-fit border-black"
//               alt="Export Logo"
//             />
//           </div>
//         </div>
//         {/*CheckBox */}
//         <div className="col-span-5 row-span-2   text-blue-800 lg:font-bold p-4">
//           <ul className="mt-4 lg:space-y-1">
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Goods &
...
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Interest
//               Subvention Rate
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Transport and
//               Marketing Assistance (TMA) Rate
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> RoSCTL Rate
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Export & Import
//               Policy of India at Product Level
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Global Trade &
//               Tender Queries
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Import
//               Statistics of 116 Countries
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Acts, Rules,
//               Laws, Regulations
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> FAQs on
//               Banking, FTA, Policy, etc.
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Get reply on
//               query within 24 Hours
//             </li>
//             <li>
//               <input type="checkbox" checked className="mr-2" /> Free
//               Subscription & Alerts
//             </li>
//           </ul>
//         </div>
//         {/* Right Column - Ministry logo and Advertisement */}
//         <div className="col-span-4 border-black border-4 p-2  row-span-3 flex flex-col space-y-4">
//           <div className="bg-white flex justify-center items-center">
//             <div>
//               <img
//                 src="src\assets\Ministry_of_Commerce_and_Industry.svg.png"
//                 className=" object-contain w-fit h-fit border-2 p-4 border-black"
//                 alt="Ministry Logo"
//               />
//             </div>
//           </div>
...
//         <div className="col-span-8 h-full flex justify-center items-center flex-col ">
